...
public class PreparedStatements {
  ...
  public ResultSet getLaborCosts (String comp_code) throws SQLException {
    stmt = conn.prepareStatement("with salary as ("
  ...
  public ResultSet getPersonsJobs (String person_code) throws SQLException {
    stmt = conn.prepareStatement("select job_code"
  ...
  public ResultSet getPersonSkills (String person_code) throws SQLException {
    stmt = conn.prepareStatement("select ks_name"
  ...
  public ResultSet getSkillGap (String person_code) throws SQLException{
    stmt = conn.prepareStatement("with person_skills as ("
...
public ResultSet getRequiredSkills() throws SQLException {   
  //7.
    stmt = conn.prepareStatement("select ks_name"
...
public ResultSet getPersonsMissingSkills() throws SQLException {
    //8. 
    stmt = conn.prepareStatement("with has_skill as ("
            + "select ks_code"
            + "from person_skill"
            + "where person_code = '1024701'),"
            + "required_skill as ("
...
public ResultSet getCoursesCoveringMissedSkills() throws SQLException {
    //9.
    stmt = conn.prepareStatement("with required_skills as ("
...
public ResultSet getQuickestPathToQualification() throws SQLException {
    //10.
    stmt = conn.prepareStatement("with needed_skills as ("
            + "(select ks_code"
...
public ResultSet getCheapestCourse() throws SQLException {
  //11.
    stmt = conn.prepareStatement("select course_code, course_title, cost"
...
public ResultSet getCourseSets() throws SQLException {
    //12.
    stmt = conn.prepareStatement("with set_of_jobs as ("
...
public ResultSet getJobProfiles() throws SQLException {
  //13.
    stmt = conn.prepareStatement("with person_skill as ("
            + "select ks_code"
            + "from person_skill"
...
rs = stmt.executeQuery();
    ...
    public ResultSet getHighestPayinhJob() throws SQLException {
//14.
    stmt = conn.prepareStatement("with person_skills as ("
            + "select ks_code"
            + "from person_skill"
...
public ResultSet getQualifiedPersons() throws SQLException {
  //15.
    stmt = conn.prepareStatement("with required_skills as ("
            + "select ks_code"
            + "from jp_skill"
...
rs = stmt.executeQuery();
    ...
    public ResultSet getPersonsMissingOne() throws SQLException {
//16.
    stmt = conn.prepareStatement("with skill_codes as ("
            + "selec ks_code "
            + "from jp_skill"
            + "where jp_code = '666'),"
...
public ResultSet getMissingSkillCode() throws SQLException {
  //17.
    stmt = conn.prepareStatement("with skill_codes as ("
            + "select ks_code"
            + "from jp_skill"
...
rs = stmt.executeQuery();
    ...
    public ResultSet getPeopleNeedingOneNewJob() throws SQLException {
//18.
    stmt = conn.prepareStatement("with needed_skill as ("
            + "select ks_code"
            + "from jp_skill"
            + "where jp_code ='32'),"
...
public ResultSet getMissingSkillsUnderThree() throws SQLException {
  //19.
    stmt = conn.prepareStatement("with skill_list as ("
            + "select ks_code"
            + "from jp_skill"
            + "where jp_code = '100'),"
            + "missing_skill (person_code, num_missing) as ("
...
rs = stmt.executeQuery();
    ...
    public ResultSet getSkillsMissingkList() throws SQLException {
//20.
    stmt = conn.prepareStatement("with skill_codes as ("
            + "select ks_code"
            + "from jp_skill"
...
public ResultSet getPersonSpecialJob() throws SQLException {
  //21.
    stmt = conn.prepareStatement("select last_name, first_name, email"
...
rs = stmt.executeQuery();
    ...
    public ResultSet getUnemployedPeople() throws SQLException {
//22.
    stmt = conn.prepareStatement("with unemployed as ("
            + "select person_code"
            + "from person"
            + "minus"
...
public ResultSet getBiggestEmployer() throws SQLException {
  //23.
    stmt = conn.prepareStatement("with employer_count as ("
...
public ResultSet getJobDistribution() throws SQLException {
//24.
    stmt = conn.prepareStatement("with num_employees as ("
...
public ResultSet getRatio() throws SQLException {
  //25.
    stmt = conn.prepareStatement("with old_salary as ("
...
rs = stmt.executeQuery();
    ...
    public ResultSet getJobOpenings() throws SQLException {
//26.
    stmt = conn.prepareStatement("with unemployed as ("
...
public ResultSet getCoursesForUnemployed() throws SQLException {
  //27.
    stmt = conn.prepareStatement("with unemployed as ("
            + "select distinct person_code"
            + "from employment"
...
rs = stmt.executeQuery();
    ...
    public ResultSet getCoursesNeededForQualification() throws SQLException {
//28.
    stmt = conn.prepareStatement("with person_skills as ("
            + "select ks_code"
            + "from person_skill"
